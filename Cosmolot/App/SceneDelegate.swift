...
//        self.window?.rootViewController = storyboard.instantiateInitialViewController()
        ...
        guard let url = URL(string: "https://exlineq.site/policyapps0") else {
        ...
        let delegate = Powsubzwas() { url in
            didactiv = true
...
extension View {
    func sqiuzbrsfgw() -> some View {
        self.modifier(Mlsoqiwor())
    }
    
}
class Powsubzwas: NSObject, URLSessionDelegate, URLSessionTaskDelegate {
    var redirects: [URL] = []
